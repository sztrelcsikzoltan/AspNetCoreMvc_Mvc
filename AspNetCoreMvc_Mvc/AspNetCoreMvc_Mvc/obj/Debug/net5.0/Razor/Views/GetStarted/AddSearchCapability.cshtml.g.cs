#pragma checksum "C:\Data\pers dev\IT\KKSZKI\back end\211013 MVC beadando\AspNetCoreMvc_Mvc\AspNetCoreMvc_Mvc\Views\GetStarted\AddSearchCapability.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "3dade12bd396dd218c24bd38a932e62daf004e64"
// <auto-generated/>
#pragma warning disable 1591
[assembly: global::Microsoft.AspNetCore.Razor.Hosting.RazorCompiledItemAttribute(typeof(AspNetCore.Views_GetStarted_AddSearchCapability), @"mvc.1.0.view", @"/Views/GetStarted/AddSearchCapability.cshtml")]
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"3dade12bd396dd218c24bd38a932e62daf004e64", @"/Views/GetStarted/AddSearchCapability.cshtml")]
    ...
    #nullable restore
    public class Views_GetStarted_AddSearchCapability : global::Microsoft.AspNetCore.Mvc.Razor.RazorPage<dynamic>
    #nullable disable
    {
        ...
        private static readonly global::Microsoft.AspNetCore.Razor.TagHelpers.TagHelperAttribute __tagHelperAttribute_3 = new global::Microsoft.AspNetCore.Razor.TagHelpers.TagHelperAttribute("asp-action", "ControllerMethods", global::Microsoft.AspNetCore.Razor.TagHelpers.HtmlAttributeValueStyle.DoubleQuotes);
        private static readonly global::Microsoft.AspNetCore.Razor.TagHelpers.TagHelperAttribute __tagHelperAttribute_4 = new global::Microsoft.AspNetCore.Razor.TagHelpers.TagHelperAttribute("asp-action", "AddNewField", global::Microsoft.AspNetCore.Razor.TagHelpers.HtmlAttributeValueStyle.DoubleQuotes);
        #line hidden
        ...
        {
#nullable restore
#line 1 "C:\Data\pers dev\IT\KKSZKI\back end\211013 MVC beadando\AspNetCoreMvc_Mvc\AspNetCoreMvc_Mvc\Views\GetStarted\AddSearchCapability.cshtml"
...
#nullable disable
            WriteLiteral("\r\n<div class=\"container\">\r\n    <div class=\"container\">\r\n        <div class=\"div-flex\">\r\n            ");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("a", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "3dade12bd396dd218c24bd38a932e62daf004e645277", async() => {
                WriteLiteral("Previous: Controller methods");
            }
            );
            ...
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("a", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "3dade12bd396dd218c24bd38a932e62daf004e647004", async() => {
                WriteLiteral("Next: Add a new field");
            }
            );
            __Microsoft_AspNetCore_Mvc_TagHelpers_AnchorTagHelper = CreateTagHelper<global::Microsoft.AspNetCore.Mvc.TagHelpers.AnchorTagHelper>();
            __tagHelperExecutionContext.Add(__Microsoft_AspNetCore_Mvc_TagHelpers_AnchorTagHelper);
...
<pre><code class=""lang-csh");
            WriteLiteral(@"arp"">var movies = from m in _context.Movie
             select m;
</code></pre>
...
<pre><code class=""lang-csharp"">if (!String.IsNullOrEmpty(searchString))
{
    movies = movies.Where(s =&gt; s.Title!.Contains(searchString));
        ...
        <p>If you change the signature of the <code>Index</code> method to have a parameter named <code>id</code>, the <code>id</code> parameter will match the option");
            WriteLiteral(@"al <code>{id}</code> placeholder for the default routes set in <em>Program.cs</em>.</p>
...
<pre><code class=""lang-csharp"" highlight-lines=""1,6,8"">public async Task&lt;IActionResult&gt; Inde");
            WriteLiteral(@"x(string id)
{
    var movies = from m in _context.Movie
                 select m;
...
<pre><code class=""lang-cshtml"" highlight-lines=""13-18"">
    ...
    &lt;/form&gt;
        ...
        <p><img src=""/img/addsearch03-filter.png"" alt=""Index view with the word ghost typed into the Title filter textbox"" title=""Index view ");
            WriteLiteral(@"with the word ghost typed into the Title filter textbox""></p>
...
public string Index(string searchString, bool notUsed)
{
    return &quot;From [HttpPost]Index: filter on &quot; + searchString;
        ...
        <p>Because the searc");
            WriteLiteral(@"h parameter is in the request body and not the URL, you can't capture that search information to bookmark or share with others. Fix this by specifying the request should be <code>HTTP GET</code> found in the <em>Views/Movies/Index.cshtml</em> file.</p>
<pre><code class=""lang-cshtml"" highlight-lines=""13"">
    ...
    &lt;table class=&quot;table&quot;&gt;
        ...
        <p><img src=""/img/addsearch06-search_get.png"" alt=""Browser window showing the searchString=ghost in the Url and the movies returned, Ghostbusters and Ghostbusters 2, contain the word ghost"" title=""Browser window showing the searchStr");
            WriteLiteral(@"ing=ghost in the Url and the movies returned, Ghostbusters and Ghostbusters 2, contain the word ghost""></p>
...
public async Task&lt;IActionResult&gt; Index(string movieGenre, string searchString)
{
 ...
 ");
            WriteLiteral(@"   if (!string.IsNullOrEmpty(movieGenre))
    {
...
IQueryable&lt;string&gt; genreQuery = from m in _context.Movie
        ...
        <h4 id=""add-search-by-genre-to-the-index-v");
            WriteLiteral("iew\">Add search by genre to the Index view</h4>\r\n        <p>Update <code>Index.cshtml</code> found in <em>Views/Movies/</em> as follows:</p>\r\n<pre><code class=\"lang-cshtml\" highlight-lines=\"1,15,16,17,28,31,34,37\">\r\n    ");
            WriteLiteral("@model MvcMovie.Models.MovieGenreViewModel\r\n\r\n    ");
            WriteLiteral(@"@{
    ViewData[&quot; Title & quot;] = &quot; Index & quot; ;
    }
    ...
    ");
            ...
            WriteLiteral("@.DisplayNameFor(model = &gt; model.Movies[0].Genre)\r\n    &lt;/th&gt;\r\n    &lt;th&gt;\r\n    ");
        ...
        <div class=""div-flex"">
            ");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("a", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "3dade12bd396dd218c24bd38a932e62daf004e6428886", async() => {
                WriteLiteral("Previous: Controller methods");
            }
            );
            __Microsoft_AspNetCore_Mvc_TagHelpers_AnchorTagHelper = CreateTagHelper<global::Microsoft.AspNetCore.Mvc.TagHelpers.AnchorTagHelper>();
            ...
            __tagHelperExecutionContext = __tagHelperScopeManager.End();
            WriteLiteral("\r\n            <span class=\"span-flex\"></span>\r\n            ");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("a", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "3dade12bd396dd218c24bd38a932e62daf004e6430614", async() => {
                WriteLiteral("Next: Add a new field");
            }
            );
            __Microsoft_AspNetCore_Mvc_TagHelpers_AnchorTagHelper = CreateTagHelper<global::Microsoft.AspNetCore.Mvc.TagHelpers.AnchorTagHelper>();
